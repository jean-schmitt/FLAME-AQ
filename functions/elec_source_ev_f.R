...
elec_source_ev_f <- function(aeo_scen=NA,elec_mix_adj_mdl=NA,elec_mix_adj_coef=NA,elec_mix_mdl=NA,first_yr=NA,last_yr=NA, electric_grid_data_source=NA){
  ...
  if (grepl("CAMBIUM", elec_mix_mdl)|grepl("NREL", elec_mix_mdl)|(elec_mix_mdl == "current_mix")) {
    ...
    #Create matrix
    cambium_scenario <- do.call(cambium_el_grid_scenario_f, list(output = "electricity"))[["matrix_mix"]]
